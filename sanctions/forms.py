...
class SanctionForm(forms.ModelForm):
    class Meta:
        model = Sanction
        fields = ["eleve", "date", "motif", "sanction"]
        widgets = {
            ...
            "motif": forms.TextInput(attrs={
                "class": FIELD_CLASSES,
                "placeholder": "Motif (ex : perturbation en classe)",
            }),
            "sanction": forms.TextInput(attrs={
                "class": FIELD_CLASSES,
                "placeholder": "Sanction (ex : avertissement, blâme, exclusion…)",
                "list": "liste-sanctions",
            }),
        }
    ...
    def __init__(self, *args, classe=None, **kwargs):
        ...
        self.fields["eleve"].empty_label = "— Choisir un apprenant —"